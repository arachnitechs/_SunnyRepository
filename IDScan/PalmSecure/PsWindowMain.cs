...
namespace PalmSecure
{
    ...
    public partial class PsWindowMain : Form
    {
        ...
        public PsWindowMain()
        {
            ...
            //Set Module Path.
            Ps_Sample_Apl_CS_SetModulePath();
            ...
            if (!System.IO.File.Exists("PalmSecureSample_GUIDELESS.BMP"))
            {
                System.Windows.Forms.MessageBox.Show("Read Error " + "PalmSecureSample_GUIDELESS.bmp");
                pr.Kill();
            }
            if (!System.IO.File.Exists("PalmSecureSample_HANDGUIDE.BMP"))
            {
                System.Windows.Forms.MessageBox.Show("Read Error " + "PalmSecureSample_HANDGUIDE.bmp");
                pr.Kill();
            }
            if (!System.IO.File.Exists("PalmSecureSample_OK.wav"))
            {
                System.Windows.Forms.MessageBox.Show("Read Error " + "PalmSecureSample_OK.wav");
                pr.Kill();
            }
            if (!System.IO.File.Exists("PalmSecureSample_NG.wav"))
            {
                System.Windows.Forms.MessageBox.Show("Read Error " + "PalmSecureSample_NG.wav");
                pr.Kill();
            }

            try
            {
                m_PsFileAcsLang.Ps_Sample_Apl_CS_Read();
            }
            catch (Exception e)
            {
                System.Windows.Forms.MessageBox.Show("Read Error " + PsFileAccessorLang.PS_FILENAME);
            ...
            try
            {
                m_PsFileAcsIni.Ps_Sample_Apl_CS_Read();
            }
            catch (Exception e)
            {
                System.Windows.Forms.MessageBox.Show("Read Error " + PsFileAccessorIni.PS_FILENAME);
            ...
            if (! Ps_Sample_Apl_CS_InitLibrary(ref uiSensor, ref sensorExtKind, ref guideMode))
            {
                pr.Kill();
            }

            m_PsDataManager.Ps_Sample_Apl_CS_Init(
                (int)uiSensor,
                guideMode
                );
            ...
            Ps_Sample_Apl_CS_ReadGuideBmp();
            Ps_Sample_Apl_CS_InitControls();
            Ps_Sample_Apl_CS_InitIdList();
        }

        /// <summary>
        /// Set module path.
        /// </summary>
        void Ps_Sample_Apl_CS_SetModulePath()
        {
        ...
        /// </returns>
        bool Ps_Sample_Apl_CS_InitLibrary(ref uint uiSensor, ref uint sensorExtKind, ref int guideMode)
        {
        ...
        /// </summary>
        void Ps_Sample_Apl_CS_FinishLibrary()
        {
        ...
        /// </summary>
        void Ps_Sample_Apl_CS_ReadGuideBmp()
        {
            try
            {
                if (int.Parse(PsFileAccessor.g_clSetting.GuideMode) == 0)
                {
                    ImagePic.Image = new Bitmap("PalmSecureSample_GUIDELESS.BMP");
                }
                else
                {
                    ImagePic.Image = new Bitmap("PalmSecureSample_HANDGUIDE.BMP");
                }
            }
            catch
            {
                Ps_Sample_Apl_CS_ErrorMessage(PS_APP_EXCEPTION.PS_APPEX_GUIDEBMP_LOAD);
            }
        ...
        /// </summary>
        void Ps_Sample_Apl_CS_InitControls()
        {
            if (InvokeRequired)
            {
                Invoke(new InitControlsDelegate(Ps_Sample_Apl_CS_InitControlsMain));
            }
            else
            {
                Ps_Sample_Apl_CS_InitControlsMain();
            }
            return;
        }
        ...
        /// </summary>
        void Ps_Sample_Apl_CS_InitControlsMain()
        {
            this.Text = PsFileAccessor.g_clLang.MainDialog.Title;

            ModeLabel.Text = m_PsFileAcsLang.Ps_Sample_Apl_CS_GetSensorName(PsDataManager.m_sensorType) + "  " + 
        ...
        /// </summary>
        void Ps_Sample_Apl_CS_InitIdList()
        {
            if (InvokeRequired)
            {
                Invoke(new InitListDelegate(Ps_Sample_Apl_CS_InitIdListMain));
            }else{
                Ps_Sample_Apl_CS_InitIdListMain();
            }
        ...
        /// </summary>
        void Ps_Sample_Apl_CS_InitIdListMain()
        {
            Ps_Sample_Apl_CS_ClearIdList();

            foreach (string sUserid in m_PsDataManager.UserList.Keys)
            {
                Ps_Sample_Apl_CS_SetIdList(sUserid);
            }
        ...
        /// ID List Clear.
        /// </summary>
        void Ps_Sample_Apl_CS_ClearIdList()
        {
        ...
        void Ps_Sample_Apl_CS_SetIdList(string sUserid)
        {
            ...
            )
        {
            ...
            if( (GuiState & PalmSecureConstant.DNET_BioAPI_SAMPLE_AVAILABLE) != 0)
            {
                ...
                Ps_Sample_Apl_CS_ShowSilhouette(m_SilhouetteInfo);
                return PalmSecureConstant.DNET_BioAPI_OK;
            }
            ///////////////////////////////////////////////////////////////////////////
            ...
            if ((GuiState & PalmSecureConstant.DNET_BioAPI_MESSAGE_PROVIDED) != 0)
            {
                ...
                if ((Message & 0xffffff00) == PalmSecureConstant.DNET_PvAPI_NOTIFY_CAP_GUID_START)
                {
                    ...
                    {
                        Ps_Sample_Apl_CS_SetWorkMessage(
                ...
                Ps_Sample_Apl_CS_SetGuidance(langKey, false);
        ...
        {
            Ps_Sample_Apl_CS_SetWorkMessage((int)PS_WRK_MESSAGE.PS_MESSAGE_ENROLL_START);
            Ps_Sample_Apl_CS_SetGuidance("", false);
            Ps_Sample_Apl_CS_ReadGuideBmp();
            
            string userId = IDTextBox.Text.ToString();
            if (String.IsNullOrEmpty(userId) != false)
            {
                Ps_Sample_Apl_CS_SetGuidance(PsFileAccessor.g_clLang.Guidance.IllegalId, true);
                Ps_Sample_Apl_CS_SetWorkMessage("");
                return;
            }

            if (m_PsDataManager.Ps_Sample_Apl_CS_IsRegist(userId))
            {
                Ps_Sample_Apl_CS_SetGuidance(PsFileAccessor.g_clLang.Guidance.RegistId, true);
                Ps_Sample_Apl_CS_SetWorkMessage("");
                return;
            }

            if (m_PsDataManager.Ps_Sample_Apl_CS_GetRegistNum() >= PS_REGISTER_MAX)
            {
                Ps_Sample_Apl_CS_SetGuidance(PsFileAccessor.g_clLang.Guidance.MaxOver, true);
                Ps_Sample_Apl_CS_SetWorkMessage("");
                return;
            }
            ...
            enrollthread.Ps_Sample_Apl_CS_StartThread(
                new ParameterizedThreadStart(enrollthread.Ps_Sample_Apl_CS_ThreadProc),
                enrollParam
                );
        ...
        {
            Ps_Sample_Apl_CS_SetWorkMessage((int)PS_WRK_MESSAGE.PS_MESSAGE_DELETE);
            Ps_Sample_Apl_CS_SetGuidance("", false);
            ...
            if (!m_PsDataManager.Ps_Sample_Apl_CS_IsRegist(userId))
            {
                Ps_Sample_Apl_CS_SetGuidance(PsFileAccessor.g_clLang.Guidance.UnregistId, true);
                Ps_Sample_Apl_CS_SetWorkMessage("");
                return;
            }
            ...
            bool bRet = m_PsDataManager.Ps_Sample_Apl_CS_Delete(userId);
            if (bRet)
            {
                Ps_Sample_Apl_CS_SetGuidance(PsFileAccessor.g_clLang.CompleteMessage.Delete, false);
            }
            else
            {
                Ps_Sample_Apl_CS_ErrorMessage(PS_APP_EXCEPTION.PS_APPEX_FILE_DELETE);
            }
        ...
        private void CancelBtn_Click(object sender, EventArgs e)
        {
            ...
            cancelthread.Ps_Sample_Apl_CS_StartThread(
                new ParameterizedThreadStart(cancelthread.Ps_Sample_Apl_CS_ThreadProc),
                cancelParam
                );
        ...
        {
            Ps_Sample_Apl_CS_SetWorkMessage((int)PS_WRK_MESSAGE.PS_MESSAGE_VERIFY_START);
            Ps_Sample_Apl_CS_SetGuidance("", false);
            Ps_Sample_Apl_CS_ReadGuideBmp();
            ...
            verifythread.Ps_Sample_Apl_CS_StartThread(
                new ParameterizedThreadStart(verifythread.Ps_Sample_Apl_CS_ThreadProc),
                verifyParam
                );
        ...
        {
            Ps_Sample_Apl_CS_SetWorkMessage((int)PS_WRK_MESSAGE.PS_MESSAGE_IDENTIFY_START);
            Ps_Sample_Apl_CS_SetGuidance("", false);

            if (m_PsDataManager.Ps_Sample_Apl_CS_GetRegistNum() <= 0)
            {
                Ps_Sample_Apl_CS_SetGuidance(PsFileAccessor.g_clLang.Guidance.Unregist, true);
                Ps_Sample_Apl_CS_SetWorkMessage("");
                return;
            }
            ...
            Identifythread.Ps_Sample_Apl_CS_StartThread(
                new ParameterizedThreadStart(Identifythread.Ps_Sample_Apl_CS_ThreadProc),
                identifyParam
                );
        ...
        public void Ps_Sample_Apl_CS_EndEnroll(PS_THREAD_RESULT stResult,int enrollScore)
        {
                ...
                || m_CancelFlg == true)
            {
                if (m_CancelFlg == true)
                {
                    Ps_Sample_Apl_CS_SetGuidance(PsFileAccessor.g_clLang.CompleteMessage.EnrollCancel, false);
                }
                else
                {
                    Ps_Sample_Apl_CS_SetGuidance(PsFileAccessor.g_clLang.CompleteMessage.EnrollNg, true);
                }
            }
            else
            {
                ...
                {
                    Ps_Sample_Apl_CS_SetGuidance( PsFileAccessor.g_clLang.CompleteMessage.EnrollRetry, false );
                }
                else
                {
                    Ps_Sample_Apl_CS_SetGuidance( PsFileAccessor.g_clLang.CompleteMessage.EnrollOk, false );
                }
            }
                ...
                && m_CancelFlg != true)
            {
                ...
                tbl.silhouette           = lm.Ps_Sample_Apl_CS_OutputSilhouette(stResult.info);
            }
        ...
        /// </summary>
        /// <param name="stResult">Result information.</param>
        public void Ps_Sample_Apl_CS_EndVerify(PS_THREAD_RESULT stResult)
        {
            PsLogManager lm = new PsLogManager(this);
            PS_LOG_TBL tbl = new PS_LOG_TBL();
            tbl.result = false;
            ...
            try
            {
                ...
                {
                    tbl.result = true;
                    player = new System.Media.SoundPlayer("PalmSecureSample_OK.wav");
                    player.Play();
                    Ps_Sample_Apl_CS_SetGuidance(PsFileAccessor.g_clLang.CompleteMessage.VerifyOk, false, stResult.userId[0]);
                }
                else
                {
                    if (m_CancelFlg == true)
                    {
                        Ps_Sample_Apl_CS_SetGuidance(PsFileAccessor.g_clLang.CompleteMessage.VerifyCancel, false, stResult.userId[0]);
                    }
                    else
                    {
                        player = new System.Media.SoundPlayer("PalmSecureSample_NG.wav");
                        player.Play();
                        Ps_Sample_Apl_CS_SetGuidance(PsFileAccessor.g_clLang.CompleteMessage.VerifyNg, true, stResult.userId[0]);
                    }
                }
            }
            catch(Exception e)
        ...
        /// </summary>
        /// <param name="stResult">Result information</param>
        public void Ps_Sample_Apl_CS_EndIdentify(PS_THREAD_RESULT stResult)
        {
            PsLogManager lm = new PsLogManager(this);
            PS_LOG_TBL tbl = new PS_LOG_TBL();
            tbl.result = false;
            ...
            try 
            {
                    ...
                    && m_CancelFlg != true)
                {
                    ...
                    player = new System.Media.SoundPlayer("PalmSecureSample_OK.wav");
                    player.Play();
                    Ps_Sample_Apl_CS_SetGuidance(PsFileAccessor.g_clLang.CompleteMessage.IdentifyOk, false, stResult.userId[0]);
                }
                else
                {
                    if (m_CancelFlg == true)
                    {
                        Ps_Sample_Apl_CS_SetGuidance(PsFileAccessor.g_clLang.CompleteMessage.IdentifyCancel, false, "");
                    }
                    else
                    {
                        player = new System.Media.SoundPlayer("PalmSecureSample_NG.wav");
                        player.Play();
                        Ps_Sample_Apl_CS_SetGuidance(PsFileAccessor.g_clLang.CompleteMessage.IdentifyNg, true, "");
                    }
                }
            }
            catch(Exception e)
        ...
        public void Ps_Sample_Apl_CS_SetGuidance(string msg, bool bErr=false, string userId=null)
        {
            if (InvokeRequired)
            {
                Invoke(new SetGuidanceDelegate(Ps_Sample_Apl_CS_SetGuidanceMain), msg, bErr, userId);
            }
            else
            {
                Ps_Sample_Apl_CS_SetGuidanceMain(msg, bErr, userId);
            }
        ...
        /// <param name="bErr">Error Flag</param>
        /// <param name="userId">User ID</param>
        void Ps_Sample_Apl_CS_SetGuidanceMain(string msg, bool bErr, string userId)
        {
            if (bErr)
            {
        ...
        public void Ps_Sample_Apl_CS_SetWorkMessage(int workid, int count=0)
        {
            if (InvokeRequired)
            {
                Invoke(new SetWorkMsgDelegateId(Ps_Sample_Apl_CS_WorkMessage), workid, count);
            }
            else
            {
                Ps_Sample_Apl_CS_WorkMessage(workid, count);
            }
        ...
        /// </summary>
        /// <param name="msg">Message</param>
        public void Ps_Sample_Apl_CS_SetWorkMessage(string msg)
        {
            if (InvokeRequired)
            {
                Invoke(new SetWorkMsgDelegateMsg(Ps_Sample_Apl_CS_WorkMessage), msg);
            }
            else
            {
                Ps_Sample_Apl_CS_WorkMessage(msg);
            }
        ...
        /// <param name="workid">Message id</param>
        /// <param name="count">Parameter</param>
        void Ps_Sample_Apl_CS_WorkMessage(int workid, int count)
        {
            string msg;
            msg = m_PsFileAcsLang.Ps_Sample_Apl_CS_GetWorkMessage((PS_WRK_MESSAGE)workid);
        ...
        /// </summary>
        /// <param name="msg">Message</param>
        void Ps_Sample_Apl_CS_WorkMessage(string msg)
        {
            if (String.IsNullOrEmpty(msg))
            {
        ...
        public void Ps_Sample_Apl_CS_ErrorMessage(PS_APP_EXCEPTION ex)
        {

            string msg = String.Format(
                    "{0}\n　{1} ",
                    m_PsFileAcsLang.Ps_Sample_Apl_CS_GetSampleErrorTitle(),
                    m_PsFileAcsLang.Ps_Sample_Apl_CS_GetSampleErrorMsg(ex)
                    );
            MessageBox.Show(msg);
        ...
        public void Ps_Sample_Apl_CS_ErrorMessage(int errcode)
        {

            string msg = String.Format("{0}\n　{1}({2}) ",
                    m_PsFileAcsLang.Ps_Sample_Apl_CS_GetSampleErrorTitle(),
                    m_PsFileAcsLang.Ps_Sample_Apl_CS_GetSampleErrorMsg(PS_APP_EXCEPTION.PS_APPEX_SYSTEM_ERROR),
                    errcode
                    );
            msg = msg.Replace("\\r\\n", "\r\n");
            MessageBox.Show(msg);
        ...
        public void Ps_Sample_Apl_CS_ErrorMessage(DNET_PvAPI_ErrorInfo inf)
        {
            string msg = String.Format(
                "{0}\n{1}:0x{2:X8}\n{3}:0x{4:X8}\n{5}:0x{6:X8}\n",
                m_PsFileAcsLang.Ps_Sample_Apl_CS_GetApiErrorTitle(),
                m_PsFileAcsLang.Ps_Sample_Apl_CS_GetApiErrorLevel(),
                inf.ErrorLevel,
                m_PsFileAcsLang.Ps_Sample_Apl_CS_GetApiErrorCode(),
                inf.ErrorCode,
                m_PsFileAcsLang.Ps_Sample_Apl_CS_GetApiErrorDetail(),
                inf.ErrorDetail
                );
